...
import com.olive.system.service.SysLoginLogService;
...
public class SysLoginLogController {
    ...
    @GetMapping("/list")
    public Page<SysLoginLog> list(SysLoginLogSearch search, PageQuery page) {
    ...
    public int remove(@PathVariable(name = "infoIds") Long[] infoIds) {
        return loginLogService.deleteLoginLogByIds(List.of(infoIds));
    }
