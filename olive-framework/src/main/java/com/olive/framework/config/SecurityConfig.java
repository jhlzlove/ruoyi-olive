...
import com.olive.framework.config.properties.PermitAllUrlProperties;
import com.olive.framework.security.filter.AuthenticationEntryPointImpl;
import com.olive.framework.filter.JwtAuthenticationTokenFilter;
import com.olive.framework.security.filter.LogoutSuccessHandlerImpl;
                ...
                .authorizeHttpRequests((requests) -> {
                    ...
                    requests.requestMatchers("/login", "/register", "/captchaImage")
                            ...
                            .requestMatchers("/swagger-ui.html", "/swagger-resources/**",
                                    "/webjars/**", "/*/api-docs",
                                    "/test/**", "/*/api-docs/**", "/openapi.*", "/openapi.html",
                                    "/openapi.json"
                            )
                            .permitAll()
