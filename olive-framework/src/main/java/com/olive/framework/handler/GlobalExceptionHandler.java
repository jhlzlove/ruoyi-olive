package com.olive.framework.handler;

import com.olive.common.response.R;
import com.olive.common.utils.html.EscapeUtil;
import com.olive.framework.exception.DemoModeException;
...
public class GlobalExceptionHandler {
    ...
    public R handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e,
        ...
        return R.error(String.format("请求参数类型不匹配，参数[%s]要求类型为：'%s'，但输入值为：'%s'", e.getName(),
